...
run_command("npm install -g create-vite")

# Create a new Vue project using create-vite
run_command("create-vite project --template vue")

# Change working directory to the project folder
os.chdir("project")

# Install Bootstrap for the project
run_command("npm install bootstrap")

# Install sass for the project
run_command("npm install --save-dev sass")
